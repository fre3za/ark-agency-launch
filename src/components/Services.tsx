      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((s) => (
          <Link
            key={s.title}
            to={s.href}
            className="group p-8 rounded-xl glass hover:border-primary/40 transition-all duration-500 hover:shadow-[0_0_30px_hsl(168_80%_48%/0.15),inset_0_1px_0_hsl(168_80%_48%/0.2)] hover:-translate-y-1"
          >
