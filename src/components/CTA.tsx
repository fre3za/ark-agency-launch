        ...
        <div className="max-w-4xl mx-auto text-center glass rounded-2xl p-12 md:p-16 relative overflow-hidden hover:border-primary/30 transition-all duration-500">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/schedule-call" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg font-semibold text-foreground border border-border hover:border-primary/50 hover:text-primary transition-colors">
                Schedule a Call
              </Link>
            </div>
          </div>
